...
<form method="POST" action="<?php echo e(route('documentos.store')); ?>" enctype="multipart/form-data" id="formProcesso">
    <?php echo csrf_field(); ?>
            ...
            <div class="processo-card">
                ...
                <div class="mb-3">
                    ...
                    <select name="tipo_documento_id" id="servicoSelect" class="p-input" required>
                        ...
                        <?php $__currentLoopData = \App\Models\TipoDocumento::where('status', 'ativo')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $servico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($servico->id); ?>"
                            data-setor="<?php echo e($servico->departamentoDestino?->nome); ?>"
                            data-setor-id="<?php echo e($servico->departamento_destino_id); ?>"
                            data-cargos="<?php echo e(json_encode($servico->cargos_responsaveis ?? [])); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="remetente" class="p-input p-input--locked" value="<?php echo e(auth()->user()->nome); ?>" readonly required>
                </div>

                <div class="mb-3">
                    <label class="p-label">Descrição</label>
                    <textarea name="descricao" class="p-input p-textarea" placeholder="Detalhes adicionais sobre a solicitação..."><?php echo e(old('descricao')); ?></textarea>
                </div>

                <div class="mb-3">
                    <label class="p-label">Data de Recebimento <span class="p-req">*</span></label>
                    <input type="date" name="data_recebimento" id="dataRecebimento" class="p-input p-input--locked" value="<?php echo e(date('Y-m-d')); ?>" readonly required>
                </div>
            </div>
            ...
            <div class="acao-card-principal">
                ...
                <a href="<?php echo e(route('documentos.index')); ?>" class="btn-secondary-sced btn-cancelar">Cancelar</a>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Controle-de-Entrada-de-Documentos\sced\resources\views/processos/create.blade.php ENDPATH**/ ?>