                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <input type="date" name="data_inicio" class="form-input" 
                                   value="<?php echo e(date('Y-m-01')); ?>" placeholder="Data Inicial">
                        </div>
                        <div class="col-6">
                            <input type="date" name="data_fim" class="form-input" 
                                   value="<?php echo e(date('Y-m-d')); ?>" placeholder="Data Final">
                        </div>
                    </div>
                </div>
...
<div class="rapidos-grid">
    <div class="relatorio-card">
        ...
        <div class="relatorio-body">
            ...
            <form method="POST" action="<?php echo e(route('relatorios.gerar')); ?>" target="_blank">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="data_inicio" value="<?php echo e(date('Y-m-01')); ?>">
                <input type="hidden" name="data_fim" value="<?php echo e(date('Y-m-d')); ?>">
