...
class ArquivoAnexo extends Model
{
    ...
    protected $fillable = [
        'documento_id','usuario_id','tipo_anexo','status_validacao',
        'observacao_validacao','validado_por','validado_em',
    ...
    public function getLabelTipoAnexoAttribute(): string     { return self::$tiposAnexo[$this->tipo_anexo] ?? 'Outros'; }
